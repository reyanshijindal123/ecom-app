...
export const card = {
  ...
  hover:
    "bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1.5",
  ...
  brand:
    "bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl border border-pink-100",
...
export const badge = {
  /** Brand pink pill */
  brand:
    "inline-flex items-center gap-1 bg-pink-50 text-[#970747] text-xs font-semibold px-2.5 py-1 rounded-full",

  /** Success green */
  success:
    "inline-flex items-center gap-1 bg-green-50 text-green-700 text-xs font-semibold px-2.5 py-1 rounded-full",

  /** Warning amber */
  warning:
    "inline-flex items-center gap-1 bg-amber-50 text-amber-700 text-xs font-semibold px-2.5 py-1 rounded-full",

  /** Danger red */
  danger:
    "inline-flex items-center gap-1 bg-red-50 text-red-600 text-xs font-semibold px-2.5 py-1 rounded-full",
...
export const modal = {
  ...
  panel:
    "relative bg-white rounded-3xl shadow-2xl w-full overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300",
  closeBtn:
    "absolute top-5 right-5 w-7 h-7 rounded-full bg-gray-100 flex items-center justify-center text-gray-400 hover:bg-gray-200 hover:text-gray-600 transition-all",
  strip: {
    brand:
      "h-1.5 w-full bg-gradient-to-r from-[#970747] via-pink-400 to-[#970747]",
    danger: "h-1.5 w-full bg-gradient-to-r from-red-400 via-red-500 to-red-400",
    success:
      "h-1.5 w-full bg-gradient-to-r from-green-400 via-green-500 to-green-400",
