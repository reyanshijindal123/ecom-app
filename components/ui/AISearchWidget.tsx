...
export default function AISearchWidget() {
  ...
  const analyzeQuery = async (q: string) => {
    ...
    if (
      ...
      suggestion =
        "I found some great women's clothing options for you! Showing curated picks based on your preference.";
      searchTerm = "";
    } else if (
      lower.includes("men") ||
      ...
      suggestion =
        "Here are the best men's fashion picks matching your description!";
    } else if (
      lower.includes("tech") ||
      ...
      suggestion =
        "Found top-rated electronics that match what you're looking for!";
    } else if (
      ...
      category = "jewelery";
      suggestion =
        "Beautiful jewellery picks curated just for you! Perfect for gifting or personal styling.";
    } else if (
