        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14">
          ...
          <div>
            ...
            <ul className="space-y-5">
              ...
              <li>
                <Link href="/products?category=jewelery">Jewellery</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-2xl font-semibold mb-8 uppercase">Contact</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <span className="text-gray-400">support@velvetstore.com</span>
              </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <Clock className="text-pink-500" />
                <span className="text-gray-400">Fri : 8:00 AM - 9:00 PM</span>
              </div>

              <div className="flex gap-4">
                <Clock className="text-pink-500" />
                <span className="text-gray-400">Sat : 9:30 AM - 3:00 PM</span>
              </div>
